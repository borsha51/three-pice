...
function render(){
 ...
 '<section class="about" id="about"><div class="aboutPhoto"></div><div class="aboutCopy"><p class="eyebrow">ABOUT OUR STORE</p><h2>Crafted for<br>Modern Women</h2><p>Made by Nexora is a premium fashion brand, offering elegant and comfortable three-piece collections for every occasion. We believe in quality, simplicity, and timeless style.</p><a class="textLink" href="#shop">Learn More <span>→</span></a></div><div class="follow"><p class="eyebrow">FOLLOW US</p><h3>Stay connected for new arrivals, style inspiration and more.</h3><div class="socialIcons"><a href="'+SOCIAL.instagram+'" target="_blank" rel="noreferrer">'+ICON.instagram+'</a><a href="'+SOCIAL.facebook+'" target="_blank" rel="noreferrer">'+ICON.facebook+'</a><a href="'+SOCIAL.tiktok+'" target="_blank" rel="noreferrer">'+ICON.tiktok+'</a></div><p>@madebynexora</p></div></section>'+
